<div>
    ...
    <section class="relative isolate min-h-[680px] overflow-hidden bg-slate-950 text-white">
        <img src="<?php echo e(asset('images/ember-hero-v2.jpg')); ?>" alt="" class="ember-hero-image absolute inset-0 -z-20 size-full object-cover" fetchpriority="high">
        ...
        <div class="mx-auto flex min-h-[680px] max-w-7xl flex-col px-4 pb-7 pt-12 sm:px-6 sm:pb-9 lg:px-8">
            ...
            <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_440px] lg:items-end">
                <div class="ember-hero-copy max-w-xl">
                    <p class="text-sm leading-6 text-slate-200 sm:text-base sm:leading-7"><?php echo e($t['intro']); ?></p>
                    <div class="mt-5 flex flex-wrap gap-3">
                        <a href="<?php echo e(route('user.map', ['lang' => $language])); ?>" class="inline-flex items-center gap-2 rounded-xl bg-red-600 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-black/25 transition hover:-translate-y-0.5 hover:bg-red-500 focus:outline-none focus:ring-4 focus:ring-red-400/30">
                            ...
                            <?php echo e($t['map_cta']); ?>

                        </a>
                        <a href="<?php echo e(route('user.statistics', ['lang' => $language])); ?>" class="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-slate-950/25 px-5 py-3 text-sm font-bold text-white backdrop-blur-md transition hover:-translate-y-0.5 hover:bg-white/10">
                            <?php echo e($t['stats_cta']); ?> <span aria-hidden="true">&rarr;</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="ember-hero-stats grid grid-cols-2 gap-2 rounded-2xl border border-white/10 bg-slate-950/30 p-2 shadow-2xl shadow-black/20 backdrop-blur-xl">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $value, $accent]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="ember-stat-card rounded-xl bg-white/[.07] px-3.5 py-3 ring-1 ring-inset ring-white/[.06]">
                            <p class="text-[10px] font-semibold text-slate-400"><?php echo e($label); ?></p>
                            <p class="mt-1.5 <?php echo e(strlen((string) $value) > 8 ? 'text-sm' : 'text-xl'); ?> font-black tracking-tight <?php echo e($accent); ?>"><?php echo e($value); ?></p>
                        </div>
        ...
        <div class="mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:px-6 lg:grid-cols-[.72fr_1.28fr] lg:items-center lg:gap-16 lg:px-8 lg:py-20">
            <div class="relative" data-reveal="left">
                ...
                <div class="inline-flex items-center gap-2 rounded-full bg-red-50 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.2em] text-red-600 ring-1 ring-inset ring-red-100">
                    <span class="size-1.5 rounded-full bg-red-500"></span><?php echo e($t['latest']); ?>

                </div>
                <h2 class="mt-4 max-w-md text-3xl font-black leading-tight tracking-[-0.03em] text-slate-950 sm:text-4xl"><?php echo e($t['latest_title']); ?></h2>
                <p class="mt-4 max-w-md text-sm leading-7 text-slate-600"><?php echo e($t['latest_desc']); ?></p>
                <a href="<?php echo e(route('user.map', ['lang' => $language])); ?>" class="group mt-7 inline-flex items-center gap-3 rounded-xl bg-slate-950 px-4 py-3 text-sm font-black text-white shadow-lg shadow-slate-950/10 transition hover:-translate-y-0.5 hover:bg-red-600">
                    <?php echo e($t['view_all']); ?> <span class="transition group-hover:translate-x-1" aria-hidden="true">&rarr;</span>
                </a>
            </div>
            ...
            <div class="rounded-[1.75rem] border border-slate-200/80 bg-white/80 p-2.5 shadow-[0_20px_60px_rgba(15,23,42,.08)] backdrop-blur" data-reveal="right">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $latestLocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php ($meta = $statusMeta($location->confidence)); ?>
                    <a href="<?php echo e(route('user.locations.show', ['id' => $location->id, 'lang' => $language])); ?>" class="group grid gap-3 rounded-2xl p-3.5 transition hover:bg-slate-50 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center sm:px-4" data-reveal data-reveal-delay="<?php echo e($loop->index * 70); ?>">
                        <div class="flex min-w-0 items-start gap-3">
                            ...
                            <div class="min-w-0">
                                <p class="truncate text-[15px] font-black text-slate-950"><?php echo e($location->desa ?: $t['unknown_village']); ?></p>
                                <p class="mt-1 truncate text-xs font-medium text-slate-500"><?php echo e(collect([$location->kecamatan, $location->kabupaten_kota, $location->provinsi])->filter()->join(', ') ?: '-'); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center justify-between gap-3 pl-12 sm:justify-end sm:pl-0">
                            <span class="rounded-full px-2.5 py-1 text-[10px] font-black ring-1 ring-inset <?php echo e($meta['class']); ?>"><?php echo e($meta['label']); ?></span>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <p class="p-8 text-center text-sm text-slate-500"><?php echo e($t['no_latest']); ?></p>
    ...
    <section class="relative isolate overflow-hidden bg-white">
        ...
        <div class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
            <div class="flex flex-col justify-between gap-5 sm:flex-row sm:items-end" data-reveal>
                <div class="max-w-2xl">
                    <div class="inline-flex items-center gap-2 rounded-full bg-slate-100 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-600">
                        <span class="size-1.5 rounded-full bg-red-500"></span><?php echo e($t['explore']); ?>

                    </div>
                    <h2 class="mt-4 text-3xl font-black tracking-[-0.03em] text-slate-950 sm:text-4xl"><?php echo e($t['explore_title']); ?></h2>
                </div>
                <p class="max-w-sm text-sm leading-6 text-slate-500"><?php echo e($language === 'en' ? 'Explore how EMBER works, where the data comes from, and who manages it.' : 'Pelajari cara kerja EMBER, asal data, dan siapa yang mengelolanya.'); ?></p>
            </div>
            <div class="mt-9 grid gap-5 md:grid-cols-3">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$number, $title, $description, $url, $icon]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e($url); ?>" class="motion-lift group relative min-h-72 overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-white to-slate-50 p-6 shadow-sm transition duration-300 hover:border-red-200 hover:shadow-2xl hover:shadow-slate-950/[.08] sm:p-7" data-reveal data-reveal-delay="<?php echo e($loop->index * 110); ?>">
                        <span class="absolute -right-3 -top-8 text-[8rem] font-black leading-none text-slate-100 transition duration-300 group-hover:text-red-50" aria-hidden="true"><?php echo e($number); ?></span>
                        <div class="relative flex items-center justify-between">
                            <span class="flex size-12 items-center justify-center rounded-2xl bg-white text-red-600 shadow-md shadow-slate-950/[.05] ring-1 ring-slate-200 transition group-hover:rotate-[-4deg] group-hover:bg-red-600 group-hover:text-white group-hover:ring-red-600"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" class="size-5" aria-hidden="true"><path d="<?php echo e($icon); ?>"/></svg></span>
                        ...
                        <div class="relative mt-12">
                            <h3 class="text-2xl font-black tracking-tight text-slate-950"><?php echo e($title); ?></h3>
                            <p class="mt-3 text-sm leading-6 text-slate-600"><?php echo e($description); ?></p>
                            <span class="mt-6 inline-flex items-center gap-2 text-xs font-black uppercase tracking-wider text-slate-900 transition group-hover:text-red-600"><?php echo e($t['read_more']); ?> <span class="transition group-hover:translate-x-1" aria-hidden="true">&rarr;</span></span>
                        </div>
                    </a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
...
<?php /**PATH D:\capstone\ember-neko-main\resources\views/livewire/user/dashboard.blade.php ENDPATH**/ ?>